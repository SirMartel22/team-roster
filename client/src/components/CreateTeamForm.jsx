...
export function CreateTeamForm() {
  ...
  return (
    <form onSubmit={submit} className="auth-form">
      ...
      <div className="auth-form-row"><div className="auth-input-group"><label htmlFor="teamEmail">Email address</label><input className="auth-input" id="teamEmail" name="email" type="email" value={fields.email} onChange={update} autoComplete="email" /></div><div className="auth-input-group"><label htmlFor="teamPassword">Password</label><PasswordInput id="teamPassword" name="password" value={fields.password} onChange={update} autoComplete="new-password" /></div></div>
